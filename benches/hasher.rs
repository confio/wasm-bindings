...
fn bench_run_llvm(c: &mut Criterion) {
    ...
    c.bench_function("wasm_hash_llvm(100, 16, 43)", |b| b.iter(|| run(&instance, black_box(100), black_box(16), black_box( 43))));
}
...
#[cfg(feature = "llvm")]
criterion_group!(example, bench_run_singlepass, bench_run_clif, bench_run_llvm, bench_run_metered);
